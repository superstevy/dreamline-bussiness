    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_logo', cloudinary.models.CloudinaryField(max_length=255, verbose_name='Company Logo')),
                ('role', models.CharField(max_length=50, verbose_name='Role In Companty')),
                ('generated_background', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='Generated Background')),
